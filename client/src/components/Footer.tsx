        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-slate-400 leading-relaxed text-sm">
              Une approche orientée ROI pour digitaliser, attirer et convertir. Nous transformons votre présence en ligne en moteur de croissance.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span>123 Avenue de la Performance<br />75000 Paris, France</span>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="w-5 h-5 text-accent shrink-0" />
                <a href="mailto:contact@cdcall.fr" className="hover:text-white">contact@cdcall.fr</a>
              </li>
              <li className="flex items-center gap-3">
