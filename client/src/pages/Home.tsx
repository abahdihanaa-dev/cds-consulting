...
import { 
  ArrowRight, CheckCircle2, BarChart3, Globe, Zap, Search, Target, MousePointerClick, 
...
export default function Home() {
  ...
  return (
    <Layout>
      {/* 1. HERO SECTION */}
      <section className="relative overflow-hidden bg-primary pb-16 pt-8 md:pb-32 md:pt-20 lg:pt-32">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-white leading-[1.1] mb-6">
                Digitalisez. <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent to-orange-300">Attirez.</span> <br />
                Convertissez.
              </h1>
              
              <p className="text-lg text-slate-300 mb-8 leading-relaxed max-w-xl mx-auto lg:mx-0">
                Un système complet pour votre croissance : Site Web performant, Stratégie SEO, 
                Publicité Meta Ads et Tracking précis. Ne laissez plus le hasard décider de vos résultats.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-10">
                ...
                <Link href="/services">
                  <Button variant="outline" className="h-14 px-8 text-lg bg-transparent border-slate-600 text-white hover:bg-white/10 hover:border-white rounded-xl transition-all">
                    Voir nos services
                  </Button>
                </Link>
              </div>
              ...
              <div className="flex flex-wrap gap-4 justify-center lg:justify-start text-sm text-slate-400 font-medium">
                {["Approche orientée ROI", "Tracking clair", "Itérations rapides"].map((item, i) => (
              ...
              <div className="relative z-10 bg-slate-800/50 backdrop-blur-xl border border-slate-700 rounded-2xl p-6 shadow-2xl transform rotate-3 hover:rotate-0 transition-transform duration-500">
                ...
                <div className="bg-slate-900 rounded-xl p-4 mb-4 border border-slate-800">
                  <div className="flex justify-between items-center mb-6">
                    <div>
                      <div className="text-xs text-slate-400 mb-1">Revenus mensuels</div>
                  ...
                  <div className="h-32 flex items-end gap-2">
                    {[30, 45, 35, 60, 55, 75, 85].map((h, i) => (
                      <div key={i} className="flex-1 bg-accent/80 rounded-t-sm hover:bg-accent transition-colors" style={{ height: `${h}%` }} />
                    ))}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-slate-900 p-4 rounded-xl border border-slate-800">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-slate-400 text-xs">Nouveaux leads</span>
                    </div>
                  ...
                  <div className="bg-slate-900 p-4 rounded-xl border border-slate-800">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-slate-400 text-xs">Taux de conversion</span>
                    </div>
      ...
      <section className="section-padding bg-white relative">
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-3xl md:text-4xl mb-6">Pourquoi la digitalisation est devenue <span className="text-accent">obligatoire</span> ?</h2>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div className="space-y-6 text-lg text-slate-600 leading-relaxed">
              <p>
                Le comportement d'achat a radicalement changé. Aujourd'hui, <strong>87% des parcours d'achat commencent en ligne</strong>. 
                Que vous soyez artisan, PME ou grand groupe, votre client vous cherche d'abord sur Google.
              </p>
              <p>
                La confiance se joue en quelques secondes. Un site lent, mal adapté aux mobiles ou introuvable, c'est un client offert à la concurrence.
                La digitalisation n'est plus une "option luxe", c'est votre vitrine principale.
              </p>
              <p>
                Pire encore : la visibilité organique baisse chaque année. Sans une stratégie active (SEO ou Publicité), 
                vous devenez invisible. C.D.CALL vous remet dans la lumière.
              </p>
            </div>
            ...
            <div className="bg-slate-50 border border-red-100 rounded-2xl p-8 shadow-sm">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl font-bold text-slate-800">Les 6 erreurs fatales</h3>
              </div>
      ...
      <section className="section-padding bg-slate-50">
        <div className="container-custom">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-600">4 piliers pour une stratégie digitale inébranlable</p>
          </div>
              ...
              <Card key={i} className="border-none shadow-md hover:shadow-xl transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <div className="pt-4 border-t border-slate-100">
                    <span className="text-xs font-semibold text-slate-500 uppercase tracking-wider">{service.ex}</span>
                  </div>
                </CardContent>
              </Card>
            ))}
      ...
      <section className="section-padding bg-slate-900 text-white relative overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl text-white mb-6">Nos Packs Stratégiques</h2>
            <p className="text-slate-400 max-w-2xl mx-auto">Choisissez la vitesse de votre croissance. Des solutions packagées pour des résultats prévisibles.</p>
          </div>
            ...
            {[
              {
                ...
                features: ["Site WordPress responsive", "Optimisation technique SEO", "Intégration Google Analytics", "Formation prise en main", "Maintenance 1 mois offerte"],
              ...
              },
              {
                ...
                features: ["Tout du pack Présence", "Campagnes Meta Ads (FB/Insta)", "Landing Page haute conversion", "Tracking avancé GTM", "Reporting hebdomadaire"],
              ...
              },
              {
                ...
                features: ["Audit complet concurrentiel", "Stratégie de contenu (Blog)", "SEO Off-site (Backlinks)", "Automation CRM & Emailing", "Accompagnement VIP dédié"],
              ...
              >
                ...
                <div className="text-accent font-bold mb-2 uppercase text-sm tracking-wider">{pack.focus}</div>
                <p className="text-slate-300 text-sm mb-8 h-16">{pack.desc}</p>
                
                <ul className="space-y-4 mb-8">
                  {pack.features.map((feat, j) => (
                    <li key={j} className="flex items-start gap-3 text-sm text-slate-300">
                      <CheckCircle2 className={`w-5 h-5 shrink-0 ${pack.highlight ? "text-accent" : "text-slate-500"}`} />
                      {feat}
                    </li>
                  ))}
                </ul>
                ...
                <Link href="/audit-contact">
                  <Button className={`w-full py-6 text-lg font-bold rounded-xl ${
                    pack.highlight 
      ...
      <section className="py-16 bg-slate-50 border-y border-slate-200">
        <div className="container-custom">
          <p className="text-center text-slate-500 font-medium mb-8">ILS NOUS FONT CONFIANCE</p>
          <div className="flex flex-wrap justify-center gap-12 md:gap-24 opacity-60 grayscale hover:grayscale-0 transition-all duration-500">
            ...
            <div className="flex items-center gap-2 text-2xl font-bold text-slate-800">
              <div className="w-10 h-10 bg-slate-800 rounded-lg"></div> Culture Habitat
            </div>
            <div className="flex items-center gap-2 text-2xl font-bold text-slate-800">
              <div className="w-10 h-10 bg-accent rounded-full"></div> OBF Energie
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section-padding bg-white">
        <div className="container-custom max-w-3xl">
          ...
          <div className="space-y-4">
            {[
              { q: "Combien coûte un accompagnement ?", a: "Tout dépend de vos objectifs. Nos offres démarrent à partir de forfaits accessibles pour les TPE, jusqu'à des solutions sur-mesure pour les grands comptes. L'audit nous permet de chiffrer précisément." },
              { q: "En combien de temps aurai-je des résultats ?", a: "Pour la publicité (Meta Ads), les premiers leads arrivent souvent en moins de 7 jours. Pour le SEO, comptez 3 à 6 mois pour un impact durable." },
              { q: "Suis-je propriétaire de mon site ?", a: "Oui, à 100%. Aucune location chez nous. Une fois livré, le site et le nom de domaine vous appartiennent intégralement." },
              { q: "Travaillez-vous avec toute la France ?", a: "Absolument. Nos outils digitaux nous permettent d'accompagner des clients partout en France et en Europe avec la même efficacité." },
              { q: "Qu'est-ce que l'audit gratuit ?", a: "C'est une analyse de 30 minutes de votre présence actuelle. Nous identifions les bloquants et vous donnons un plan d'action, sans engagement." }
            ].map((faq, i) => (
